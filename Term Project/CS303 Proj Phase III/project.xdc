...
set_property -dict { PACKAGE_PIN P17  IOSTANDARD LVCMOS33 } [get_ports { BTN_A }];
set_property -dict { PACKAGE_PIN M17  IOSTANDARD LVCMOS33 } [get_ports { BTN_B }];

set_property -dict { PACKAGE_PIN V10  IOSTANDARD LVCMOS33 } [get_ports { Y_in_A[2] }];
set_property -dict { PACKAGE_PIN U11  IOSTANDARD LVCMOS33 } [get_ports { Y_in_A[1] }];
set_property -dict { PACKAGE_PIN U12  IOSTANDARD LVCMOS33 } [get_ports { Y_in_A[0] }];

set_property -dict { PACKAGE_PIN  H6  IOSTANDARD LVCMOS33 } [get_ports { DIR_A[1] }];
set_property -dict { PACKAGE_PIN T13  IOSTANDARD LVCMOS33 } [get_ports { DIR_A[0] }];

set_property -dict { PACKAGE_PIN M13  IOSTANDARD LVCMOS33 } [get_ports { Y_in_B[2] }];
set_property -dict { PACKAGE_PIN L16  IOSTANDARD LVCMOS33 } [get_ports { Y_in_B[1] }];
set_property -dict { PACKAGE_PIN J15  IOSTANDARD LVCMOS33 } [get_ports { Y_in_B[0] }];

set_property -dict { PACKAGE_PIN R17  IOSTANDARD LVCMOS33 } [get_ports { DIR_B[1] }];
set_property -dict { PACKAGE_PIN R15  IOSTANDARD LVCMOS33 } [get_ports { DIR_B[0] }];
